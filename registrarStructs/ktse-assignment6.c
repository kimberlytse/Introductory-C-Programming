...
//If there is nothing filled in a certain seat, returns "unfilled" for each class (True/false funct)
...
int main(void) {
	...
	while (userKey != 'q') {
    	...
    	/*
    	NOTE: in the switch case, it's repeated code for each class. Refer to Calculus II class
    	*/
